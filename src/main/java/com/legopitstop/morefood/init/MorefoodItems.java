...
import com.legopitstop.morefood.foods.LikePufferfish.Pufferfish;
...
import com.legopitstop.morefood.foods.LikeRottenFlesh.RottenFlesh;
...
public class MorefoodItems {
    ...
    public static final RegistryObject<BaconEggMuffin> BACON_EGG_MUFFIN = ITEMS.register("bacon_egg_muffin", BaconEggMuffin::new);
    ...
    public static final RegistryObject<Beetroot> TOMATO_KETCHUP = ITEMS.register("tomato_ketchup", Beetroot::new);
    ...
    public static final RegistryObject<Beetroot> VANILLA_EXTRACT = ITEMS.register("vanilla_extract", Beetroot::new);
    ...
    public static final RegistryObject<BeetrootSoup> ORANGE_JUICE = ITEMS.register("orange_juice", BeetrootSoup::new);
    public static final RegistryObject<BeetrootSoup> APPLE_JUICE = ITEMS.register("apple_juice", BeetrootSoup::new);
    public static final RegistryObject<BeetrootSoup> GRAPE_JUICE = ITEMS.register("grape_juice", BeetrootSoup::new);
    public static final RegistryObject<BeetrootSoup> CEREAL = ITEMS.register("cereal", BeetrootSoup::new);
    public static final RegistryObject<BeetrootSoup> APPLE_SODA = ITEMS.register("apple_soda", BeetrootSoup::new);
    public static final RegistryObject<BeetrootSoup> BERRY_SODA = ITEMS.register("berry_soda", BeetrootSoup::new);
    public static final RegistryObject<BeetrootSoup> GRAPE_SODA = ITEMS.register("grape_soda", BeetrootSoup::new);
    public static final RegistryObject<BeetrootSoup> LEMON_SODA = ITEMS.register("lemon_soda", BeetrootSoup::new);
    public static final RegistryObject<BeetrootSoup> ORANGE_SODA = ITEMS.register("orange_soda", BeetrootSoup::new);
    public static final RegistryObject<BeetrootSoup> STRAWBERRY_SODA = ITEMS.register("strawberry_soda", BeetrootSoup::new);
    public static final RegistryObject<BeetrootSoup> CHOCOLATE_MILKSHAKE = ITEMS.register("chocolate_milkshake", BeetrootSoup::new);
    public static final RegistryObject<BeetrootSoup> STRAWBERRY_MILKSHAKE = ITEMS.register("strawberry_milkshake", BeetrootSoup::new);
    public static final RegistryObject<BeetrootSoup> BANANA_MILKSHAKE = ITEMS.register("banana_milkshake", BeetrootSoup::new);
    public static final RegistryObject<BeetrootSoup> HOT_COFFEE = ITEMS.register("hot_coffee", BeetrootSoup::new);
    public static final RegistryObject<BeetrootSoup> HOT_TEA = ITEMS.register("hot_tea", BeetrootSoup::new);
    public static final RegistryObject<BeetrootSoup> HOT_COCOA = ITEMS.register("hot_cocoa", BeetrootSoup::new);
    public static final RegistryObject<BeetrootSoup> COCONUT_MILK = ITEMS.register("coconut_milk", BeetrootSoup::new);
    public static final RegistryObject<BeetrootSoup> TOMATO_JUICE = ITEMS.register("tomato_juice", BeetrootSoup::new);
    public static final RegistryObject<BeetrootSoup> BERRY_JUICE = ITEMS.register("berry_juice", BeetrootSoup::new);
    public static final RegistryObject<BeetrootSoup> STRAWBERRY_JUICE = ITEMS.register("strawberry_juice", BeetrootSoup::new);
    public static final RegistryObject<BeetrootSoup> MIXED_FRUIT_JUICE = ITEMS.register("mixed_fruit_juice", BeetrootSoup::new);
    public static final RegistryObject<BeetrootSoup> MELON_JUICE = ITEMS.register("melon_juice", BeetrootSoup::new);
    public static final RegistryObject<BeetrootSoup> LEMON_JUICE = ITEMS.register("lemon_juice", BeetrootSoup::new);
    public static final RegistryObject<BeetrootSoup> BANANA_SMOOTHIE = ITEMS.register("banana_smoothie", BeetrootSoup::new);
    public static final RegistryObject<BeetrootSoup> BERRY_SMOOTHIE = ITEMS.register("berry_smoothie", BeetrootSoup::new);
    public static final RegistryObject<BeetrootSoup> GRAPE_SMOOTHIE = ITEMS.register("grape_smoothie", BeetrootSoup::new);
    public static final RegistryObject<BeetrootSoup> STRAWBERRY_SMOOTHIE = ITEMS.register("strawberry_smoothie", BeetrootSoup::new);
    public static final RegistryObject<BeetrootSoup> MIXED_FRUIT_SMOOTHIE = ITEMS.register("mixed_fruit_smoothie", BeetrootSoup::new);
    public static final RegistryObject<BeetrootSoup> APPLE_ICECRUSH = ITEMS.register("apple_icecrush", BeetrootSoup::new);
    public static final RegistryObject<BeetrootSoup> BERRY_ICECRUSH = ITEMS.register("berry_icecrush", BeetrootSoup::new);
    public static final RegistryObject<BeetrootSoup> GRAPE_ICECRUSH = ITEMS.register("grape_icecrush", BeetrootSoup::new);
    public static final RegistryObject<BeetrootSoup> LEMON_ICECRUSH = ITEMS.register("lemon_icecrush", BeetrootSoup::new);
    public static final RegistryObject<BeetrootSoup> MELON_ICERUSH = ITEMS.register("melon_icecrush", BeetrootSoup::new);
    public static final RegistryObject<BeetrootSoup> MIXED_FRUIT_ICECRUSH = ITEMS.register("mixed_fruit_icecrush", BeetrootSoup::new);
    public static final RegistryObject<BeetrootSoup> ORANGE_ICERUSH = ITEMS.register("orange_icecrush", BeetrootSoup::new);
    public static final RegistryObject<BeetrootSoup> STRAWBERRY_ICECRUSH = ITEMS.register("strawberry_icecrush", BeetrootSoup::new);
    public static final RegistryObject<BeetrootSoup> AMERICANO = ITEMS.register("americano", BeetrootSoup::new);
    public static final RegistryObject<BeetrootSoup> CAPPUCCINO = ITEMS.register("cappuccino", BeetrootSoup::new);
    public static final RegistryObject<BeetrootSoup> MACCHIATO = ITEMS.register("macchiato", BeetrootSoup::new);
    public static final RegistryObject<BeetrootSoup> MOCHA = ITEMS.register("mocha", BeetrootSoup::new);
    public static final RegistryObject<BeetrootSoup> TOFFEE_LATTE = ITEMS.register("toffee_latte", BeetrootSoup::new);
    public static final RegistryObject<BeetrootSoup> VANILLA_LATTE = ITEMS.register("vanilla_latte", BeetrootSoup::new);
    public static final RegistryObject<BeetrootSoup> APPLE_RASPBERRY_ICERUSH = ITEMS.register("apple_raspberry_icecrush", BeetrootSoup::new);
    public static final RegistryObject<BeetrootSoup> RASPBERRY_SMOOTHIE = ITEMS.register("raspberry_smoothie", BeetrootSoup::new);
    ...
    public static final RegistryObject<CookedChicken> CHICKEN_SELECT = ITEMS.register("chicken_select", CookedChicken::new);
    ...
    public static final RegistryObject<Cookie> STRAWBERRY_JELLY = ITEMS.register("strawberry_jelly", Cookie::new);
    ...
    public static final RegistryObject<Cookie> ORANGE_JELLY = ITEMS.register("orange_jelly", Cookie::new);
    ...
    public static final RegistryObject<DriedKelp> WARPED_BERRIES = ITEMS.register("warped_berries", DriedKelp::new);
    ...
    public static final RegistryObject<GoldenCarrot> POPCORN_BUCKET = ITEMS.register("popcorn_bucket", GoldenCarrot::new);
    ...
    public static final RegistryObject<MelonSlice> SHROOMLIGHT_SLICES = ITEMS.register("shroomlight_slices", MelonSlice::new);

    public static final RegistryObject<MilkBucket> CHEESE_BUCKET = ITEMS.register("cheese_bucket", MilkBucket::new);
    public static final RegistryObject<MilkBucket> MILK_CARTON = ITEMS.register("milk_carton", MilkBucket::new);
    public static final RegistryObject<MilkBucket> CREAM_CARTON = ITEMS.register("cream_carton", MilkBucket::new);
    ...
    public static final RegistryObject<Pufferfish> CIDER = ITEMS.register("cider", Pufferfish::new);
    public static final RegistryObject<Pufferfish> RED_WINE = ITEMS.register("red_wine", Pufferfish::new);
    public static final RegistryObject<Pufferfish> WHITE_WINE = ITEMS.register("white_wine", Pufferfish::new);
    public static final RegistryObject<Pufferfish> BEER = ITEMS.register("beer", Pufferfish::new);
    ...
    public static final RegistryObject<RottenFlesh> ROTTEN_PORKCHOP = ITEMS.register("rotten_porkchop", RottenFlesh::new);
    ...
    public static final RegistryObject<SwordItem> WOODEN_KNIFE = ITEMS.register("wooden_knife",
            () -> new SwordItem(ItemTier.WOOD, 2, 0, new Item.Properties().group(MoreFood.TAB)));

    public static final RegistryObject<SwordItem> STONE_KNIFE = ITEMS.register("stone_knife",
            () -> new SwordItem(ItemTier.STONE, 2, 0, new Item.Properties().group(MoreFood.TAB)));

    public static final RegistryObject<SwordItem> IRON_KNIFE = ITEMS.register("iron_knife",
            () -> new SwordItem(ItemTier.IRON, 2, 0, new Item.Properties().group(MoreFood.TAB)));

    public static final RegistryObject<SwordItem> GOLDEN_KNIFE = ITEMS.register("golden_knife",
            () -> new SwordItem(ItemTier.GOLD, 2, 0, new Item.Properties().group(MoreFood.TAB)));

    public static final RegistryObject<SwordItem> DIAMOND_KNIFE = ITEMS.register("diamond_knife",
            () -> new SwordItem(ItemTier.DIAMOND, 2, 0, new Item.Properties().group(MoreFood.TAB)));

    public static final RegistryObject<SwordItem> NETHERITE_KNIFE = ITEMS.register("netherite_knife",
            () -> new SwordItem(ItemTier.NETHERITE, 2, 0, new Item.Properties().group(MoreFood.TAB)));

    public static final RegistryObject<SwordItem> WOODEN_SPOON = ITEMS.register("wooden_spoon",
            () -> new SwordItem(ItemTier.WOOD, 0, -3, new Item.Properties().group(MoreFood.TAB)));
}
